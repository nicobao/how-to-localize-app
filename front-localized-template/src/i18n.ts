...
// loading files from frontend
const httpBackendOptions = {
    loadPath: '/locales/{{lng}}/{{ns}}.json',
    addPath: '/locales/{{lng}}/{{ns}}.json',
}

/* Example of missing translation endpoint */
// const MissingTranslation = async (language: any, namespace: any, key: any) => 
...
i18next
    ...
    .use(HttpApi)
    .init({
        supportedLngs: availableLanguages.map(function (lng: any) {
